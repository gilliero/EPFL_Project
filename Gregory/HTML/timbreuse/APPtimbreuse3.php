...
if ($result->num_rows == 0) {
    header("Location: APPtimbreuse.php");
    exit();
}
...
if ($lastTimbrageType === 'out') {
    header("Location: APPtimbreuse2.php");
    exit();
}
...
<body>
    ...
    ?>
        ...
        <p>
        <a class="link-calendar" href="../../PHP/Calendar/APPCalendar.php">Entrez vos heures manuellement</a>
        </p>  
    </main>
