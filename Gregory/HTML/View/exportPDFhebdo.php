...
// Calculer les dates limites de la semaine
$firstday = reset($jours_semaine)['date'];
$lastday = end($jours_semaine)['date'];
...
$pdf->Cell(0, 10, utf8_decode("Semaine du " . $jours_semaine[0]['format'] . " au " . $jours_semaine[4]['format']), 0, 1, 'C');
$pdf->Ln(5);
...
$pdf->SetFont('Arial', 'B', 12);
$pdf->Cell(0, 10, utf8_decode("Heures totales travaillées : " . $heures_travaillees), 0, 1, 'C');
$pdf->Ln(5);
// Génération du PDF
ob_end_clean();
